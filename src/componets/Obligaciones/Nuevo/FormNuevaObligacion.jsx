...
export const FormNuevaObligacion = () => {
  ...
  const {divisiones,cargos,allCargos,allEspacios,espacios} = useObligacionesContext()
  ...
  const newObligacion = (values,resetForm)=>{
    ...
    axios.post("http://127.0.0.1:8000/api/v1/obligaciones",values,{headers:{
          ...
          <form className="max-w-md mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              <div className="relative z-0 w-full mb-5 group">
                ...
                {errors.docente_id && (
                  <p className=" text-red-600 text-xs">{errors.docente_id}</p>
                )}
              </div>
            ...
            <div className="relative z-0 w-full mb-5 group mt-4">
          ...
          
              {
                ...
                <div className="py-4 px-4 flex gap-2" key={dia.key}>
                  ...
                  disabled={inputDisabled} className="block  px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
